...
const RecommendedCarousel = ({ movies = [] }: { movies?: any[] }) => {
  ...
  return (
    ...
    >
      <h2 className="text-xl font-medium text-white mb-4 px-6">Recommended for You</h2>
      <div
        ref={carouselRef}
      ...
      >
        {movies.map((movie) => (
          <motion.div
            key={movie.id}
            className="w-48 flex-shrink-0 bg-gray-600 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300"
